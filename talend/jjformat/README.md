...
## Build ##
This project uses _maven-assembly-plugin_ to generate one jar with all its needed dependencies inside. It is configured to generate the assembly jar in package phase. So you only have to do `mvn clean package` then it generates jjformat-_<version>_-jar-with-dependencies.jar in target folder.
